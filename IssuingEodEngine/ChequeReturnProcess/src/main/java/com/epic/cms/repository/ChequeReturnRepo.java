...
public class ChequeReturnRepo implements ChequeReturnDao {
    ...
    public StringBuffer getNewCardNumber(StringBuffer oldCardNumber) throws Exception {
        ...
        try {
            ...
            cardNumber = backendJdbcTemplate.queryForObject(query, StringBuffer.class, status.getCARD_REPLACED_STATUS(), status.getCARD_PRODUCT_CHANGE_STATUS(), oldCardNumber);
    ...
    public CardAccountCustomerBean getCardAccountCustomer(StringBuffer cardNo) throws Exception {
        ...
        try {
            ...
            cardAccountCustomerBean = backendJdbcTemplate.queryForObject(query,
                    (rs, rowNum) -> {
    ...
    public ReturnChequePaymentDetailsBean getChequeKnockOffBean(StringBuffer cardNumber) throws Exception {
        ...
        try {
            ...
            chqPaymentKnockoffBean = backendJdbcTemplate.queryForObject(query,
                    (rs, rowNum) -> {
                        ReturnChequePaymentDetailsBean bean = new ReturnChequePaymentDetailsBean();
    ...
    public OtbBean getEOMPendingKnockOffList(StringBuffer cardnumber) throws Exception {
        ...
        try {
            ...
            eomOtbBean = backendJdbcTemplate.queryForObject(query,
                    (rs, rowNum) -> {
    ...
    public InterestDetailBean getIntProf(String accountnumber) throws Exception {
        ...
        try {
            ...
            interestDetailBean = backendJdbcTemplate.queryForObject(query,
                    (rs, rowNum) -> {
    ...
    public String getTxnIdForLastChequeByAccount(PaymentBean bean) throws EmptyResultDataAccessException {
        ...
        try {
            ...
            txnID = backendJdbcTemplate.queryForObject(query, String.class, bean.getAccountNo(), bean.getSequencenumber(), Configurations.TXN_TYPE_PAYMENT);
        } catch (EmptyResultDataAccessException ex) {
            return txnID;
        } catch (Exception ex) {
    ...
    public String getTxnIdForLastCheque(PaymentBean bean) throws EmptyResultDataAccessException {
        ...
        try {
            ...
            txnID = backendJdbcTemplate.queryForObject(query, String.class, bean.getCardnumber().toString(), bean.getSequencenumber(), Configurations.TXN_TYPE_PAYMENT);
        } catch (EmptyResultDataAccessException ex) {
    ...
    public boolean checkDuplicateChequeReturnEntry(StringBuffer cardNumber, Double txnAmount, String txnId, String traceid, String seqNo) throws EmptyResultDataAccessException {
        ...
        try {
            ...
            transactionId = backendJdbcTemplate.queryForObject(query, String.class, cardNumber.toString(), txnAmount, txnId, status.getCHEQUE_RETURN_STATUS(), seqNo, status.getCHEQUE_PAYMENT(), Configurations.TXN_TYPE_DEBIT_PAYMENT);
        } catch (EmptyResultDataAccessException ex) {
    ...
    public double getPaymentAmountBetweenDueDate(String accNO, int startEOD, String status, String dueDate) throws Exception {
        ...
        try {
            ...
            paymentAmount = backendJdbcTemplate.queryForObject(query, Double.class, Configurations.TXN_TYPE_PAYMENT, accNO, startEOD, dueDate, status, accNO);
        } catch (EmptyResultDataAccessException ex) {
    ...
    public EodInterestBean getEodInterestForCard(StringBuffer cardNo) throws Exception {
        ...
        try {
            ...
            eodInterestBean = backendJdbcTemplate.queryForObject(query,
                    (rs, rowNum) -> {
    ...
    public boolean restoreMinimumPayment(StringBuffer cardNo) throws SQLException {
        ...
        try {
            ...
            count = backendJdbcTemplate.update(query, cardNo.toString(), cardNo.toString());
            if (count == 1) {
                flag = true;
            }
        } catch (Exception ex) {
    ...
    public BlockCardBean getCardBlockOldCardStatus(StringBuffer cardNumber) throws Exception {
        ...
        try {
            ...
            blockBean = backendJdbcTemplate.queryForObject(query,
                    (rs, rowNum) -> {
    ...
    public String[] getRiskClassOnNdia(int noOfDates) throws Exception {
        ...
        try {
            ...
            bucketBean = backendJdbcTemplate.queryForObject(query,
                    (rs, rowNum) -> {
    ...
    public Boolean insertToMinPayTableOld(StringBuffer cardNo, double fee, double totalTransactions, Date dueDate, double paymentAmount) throws Exception {
        ...
        try {
            ...
            int recordCount = backendJdbcTemplate.queryForObject(allPaymentsSameDay, Integer.class, cardNo.toString(), Configurations.EOD_ID);
            if (recordCount > 0) {
