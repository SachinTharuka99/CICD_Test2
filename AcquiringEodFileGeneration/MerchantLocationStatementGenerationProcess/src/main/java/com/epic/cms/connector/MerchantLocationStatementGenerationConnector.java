...
@Service
public class MerchantLocationStatementGenerationConnector extends FileGenProcessBuilder {
    ...
    public MerchantLocationStatementGenerationConnector(RestTemplateBuilder restTemplateBuilder) {
