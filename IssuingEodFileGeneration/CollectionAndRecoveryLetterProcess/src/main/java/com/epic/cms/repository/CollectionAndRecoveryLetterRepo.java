...
public class CollectionAndRecoveryLetterRepo implements CollectionAndRecoveryLetterDao {
    ...
    public ArrayList<StringBuffer> getFirstReminderEligibleCards() throws Exception {
        ...
        try {
           // String query = "SELECT CARDNO FROM TRIGGERCARDS  WHERE LETTERGENSTATUS = ? AND LASTTRIGGERPOINT = ?";
            String query = queryParametersList.getCollectionAndRecoveryLetter_updateCashBackRedeemExp();
    ...
    public ArrayList<StringBuffer> getSecondReminderEligibleCards() throws Exception {
        ...
        try {
            //String query = "SELECT CARDNO FROM TRIGGERCARDS  WHERE LETTERGENSTATUS = ? and LASTTRIGGERPOINT = ?";
            String query = queryParametersList.getCollectionAndRecoveryLetter_getSecondReminderEligibleCards();
            if (!Configurations.STARTING_EOD_STATUS.equals(statusList.getERROR_STATUS())) {
                query = query + "and CARDNO not in (select cardno from eoderrorcards where status = ?) ";
    ...
    public boolean getTriggerEligibleStatus(String triggerPoint, String smsOrEmail) throws Exception {
        ...
        try {
            ...
            backendJdbcTemplate.query(queryParametersList.getCollectionAndRecoveryLetter_getTriggerEligibleStatus(), countCallback, triggerPoint, smsOrEmail);
    ...
    public int updateTriggerCards(StringBuffer cardNumber) throws Exception {
        ...
        try {
            ...
            count = backendJdbcTemplate.update(queryParametersList.getCollectionAndRecoveryLetter_updateTriggerCards(), Configurations.EOD_USER, Configurations.YES_STATUS, cardNumber.toString());
        } catch (Exception e) {
            throw e;
        }
        return count;
    ...
    public String getAccountNoOnCard(StringBuffer cardNumber) throws Exception {
        ...
        try {
            ...
            String query = queryParametersList.getCollectionAndRecoveryLetter_getAccountNoOnCard();
    ...
    public int insertIntoDelinquentHistory(StringBuffer cardNumber, String accountNo, String remark) throws Exception {
        ...
        try {
            ...
            count = backendJdbcTemplate.update(queryParametersList.getCollectionAndRecoveryLetter_insertIntoDelinquentHistory(), cardNumber.toString(), accountNo, remark, Configurations.EOD_USER);
        } catch (Exception e) {
            throw e;
        }
        return count;
